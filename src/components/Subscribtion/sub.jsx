    ...
    <div className="container mx-auto lg:text-center mt-20 px-8">
      ...
      <div className="mt-10 block lg:inline-flex md:inline-flex text-center">
        ...
        <input
          ...
          placeholder="Product Design"
          className="lg:block md:block  text-sm lg:py-4 lg:px-12 md:py-4 md:px-12 border-2 py-4 px-8 bg-red-500 border-red-500 focus:outline-none lg:-ml-2.5 md:-ml-2.5 -ml-6 rounded-md font-medium text-white cursor-pointer"
        />
      </div>
    </div>
  );
